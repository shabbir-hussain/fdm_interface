 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Thu Nov  3 21:42:09 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ARINC825Header1toMany
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  1 */
#define IN_PORT_1_NAME      SourceFID
...
extern void ARINC825Header1toMany_Outputs_wrapper(const uint32_T *LCC,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint32_T   *SourceFID  = (const uint32_T*) ssGetInputPortSignal(S,1);
    const uint32_T   *FSB  = (const uint32_T*) ssGetInputPortSignal(S,2);
    const uint32_T   *LCL  = (const uint32_T*) ssGetInputPortSignal(S,3);
    const uint32_T   *PVT  = (const uint32_T*) ssGetInputPortSignal(S,4);
    const uint32_T   *DOC  = (const uint32_T*) ssGetInputPortSignal(S,5);
    const uint32_T   *RCI  = (const uint32_T*) ssGetInputPortSignal(S,6);
    uint32_T        *Header  = (uint32_T *)ssGetOutputPortRealSignal(S,0);

    ARINC825Header1toMany_Outputs_wrapper(LCC, SourceFID, FSB, LCL, PVT, DOC, RCI, Header);
