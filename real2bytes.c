 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Tue Nov  1 16:35:11 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME real2bytes
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void real2bytes_Outputs_wrapper(const real_T *u0,
			uint8_T *y0,
			uint8_T *y1,
			uint8_T *y2,
			uint8_T *y3,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    uint8_T        *y4  = (uint8_T *)ssGetOutputPortRealSignal(S,4);
    uint8_T        *y5  = (uint8_T *)ssGetOutputPortRealSignal(S,5);
    uint8_T        *y6  = (uint8_T *)ssGetOutputPortRealSignal(S,6);
    uint8_T        *y7  = (uint8_T *)ssGetOutputPortRealSignal(S,7);
    uint8_T        *size  = (uint8_T *)ssGetOutputPortRealSignal(S,8);

    real2bytes_Outputs_wrapper(u0, y0, y1, y2, y3, y4, y5, y6, y7, size);
